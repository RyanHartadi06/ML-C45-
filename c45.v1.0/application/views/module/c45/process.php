    ...
    <div class="card-box">
      ...
      <div class="inbox-leftbar">
        ...
        <div class="mail-list mt-4">
          ...
          <a href="<?= base_url() ?>c45/process/performance" class="list-group-item border-0 <?= $page == 'performance' ? 'font-weight-bold' : ''; ?>">3. Performance</a>
          <a href="<?= base_url() ?>c45/process/prediksi" class="list-group-item border-0 <?= $page == 'prediksi' ? 'font-weight-bold' : ''; ?>">4. Klasifikasi</a>
        </div>
      </div>
      <!-- End Left sidebar -->
      <div class="inbox-rightbar">
        ...
        ?>
          <div class="col-md-12">
            <div class="card-box">
              <h4 style="color:#808080;">Pilih Data Excel</h4>
              <small><a href="<?= base_url(); ?>assets/c45/sample.xlsx" target="_blank">Dengan format .xlsx</a></small>
              <br>
              <form enctype="multipart/form-data" method="POST" action="<?= base_url() ?>operation/savedataset">
                <input type="file" name="files">
                <button type="submit" class="btn btn-primary btn-sm">Upload</button>
                <a href="<?= base_url() ?>operation/deletedataset" class="btn btn-danger btn-sm">Delete</a>
              </form>
            </div>
            <?php
            if ($spreadsheet != NULL) {
            ?>
              <div class="card-box table-responsive">
                <h4 style="color:#808080;">Dataset Pertandingan </h4>
        ...
        ?>
          ...
          ?>
            <div class="card-box table-responsive">
              <h4 style="color:#808080;">Tabel Dataset</h4>
        ...
        if ($page == 'prediksi') {
          ...
          ?>
            <div class="card-box">
              <div class="row">
                <div class="col-md-6">
                  <h4 style="color:#808080;">Input Data Klasifikasi</h4>
                  <form method="POST" action="">
                    ...
                    ?>
                    <div class="form-group">
                      <button class="btn btn-primary" name="prediksi" value="1" type="submit">Klasifikasi</button>
                    </div>
                  </form>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  ?><h4>Decission Tree</h4><?php
                    ...
                    <div style="" class="card card-body bg-primary text-white">
                      <h4 class="card-title mb-2 text-white">Hasil Klasifikasi</h4>
        ...
        if ($page == 'performance') {
          ...
          ?>
            <div class="card-box">
              <div class="row">
                <div class="col-md-6">
                  <h4 style="color:#808080;">Akurasi</h4>
                  ...
                  <div class="col-md-12">
                    ...
                    foreach ($newtesdata as $key) {
                      ...
                      if ($hasil_tesing == $prediksi) {
                        $benar++;
                        if ($hasil_tesing == "Terima") {
                          $tp++;
                        }
                        if ($hasil_tesing == "Tolak") {
                          $tn++;
                        }
                      } else {
                        if ($hasil_tesing == "Terima") {
                    ...
                    for ($i = 0; $i < $k; $i++) {
                      $start = $i * $subsetSize;
                      $end = ($i + 1) * $subsetSize;
                      $numbersToDisplay = array_slice($allNumbers, $start, $subsetSize);
                      echo "start" . $start . "end" . $end;
                      shuffle($numbersToDisplay); // Shuffle the array differently for each iteration

                    ?>
                      <div class="row">
                        <p>Iteration <?= $i + 1 ?></p>
                        <?php for ($j = 0; $j < $n; $j++) { ?>
                          <?php if (in_array($j + 1, $numbersToDisplay)) { // Use a portion of shuffled array 
                          ?>
                            <div class="box" style="background-color: red !important;">
                              <p><?= $j + 1 ?></p>
                            </div>
                          <?php } else { ?>
                            <div class="box">
                    ...
                    <div class="card card-body <?php if ($presisi < 60) {
                                                  echo 'bg-danger';
                                                } else if ($presisi < 80) {
                                                  echo 'bg-warning';
                                                } else {
